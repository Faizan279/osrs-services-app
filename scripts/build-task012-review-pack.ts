...
const outputZip = "task-012-final-review-pack.zip";
const metadataPath = path.join(
  "artifacts",
  "task-012",
  "task012-review-pack-metadata.txt",
);
...
const requiredExtraPaths = [
  ".env.example",
  ".github/workflows/task012-validation.yml",
  "changed-files.txt",
  ...
  "tasks/CODEX-TASK-012.md",
  "task-012-review-summary.txt",
  "prisma/schema.prisma",
  "prisma/migrations/20260730150000_task012_product_marketplace/migration.sql",
  "prisma/product-seed.ts",
  "prisma/seed-core.ts",
  "prisma/seed.ts",
  "src/lib/auth/permissions.ts",
  "src/lib/products/constants.ts",
  "src/lib/products/estimate.ts",
  "src/lib/products/inventory.ts",
  "src/lib/products/reservations.ts",
  ...
  "src/app/(public)/products/[productSlug]/page.tsx",
  "src/components/product-marketplace.tsx",
  "src/components/product-estimate-panel.tsx",
  "src/components/product-admin.tsx",
  "src/components/admin-nav.tsx",
  "src/config/public-navigation.ts",
  "src/app/(admin)/admin/products/actions.ts",
  "src/app/(admin)/admin/products/page.tsx",
  "src/app/(admin)/admin/products/categories/page.tsx",
  "src/app/(admin)/admin/products/new/page.tsx",
  "src/app/(admin)/admin/products/preview/page.tsx",
  "src/app/(admin)/admin/products/[productId]/page.tsx",
  "src/app/(admin)/admin/products/[productId]/variants/page.tsx",
  "src/app/(admin)/admin/products/[productId]/pricing/page.tsx",
  "src/app/(admin)/admin/products/[productId]/media/page.tsx",
  "src/app/(admin)/admin/products/[productId]/inventory/page.tsx",
  "src/app/(admin)/admin/products/[productId]/reservations/page.tsx",
  "src/app/(admin)/admin/products/[productId]/history/page.tsx",
  "src/tests/product-estimate.test.ts",
  "src/tests/product-inventory.test.ts",
  "src/tests/product-route.test.ts",
...
const disallowedPathPatterns = [
  ...
  /^playwright-report\//,
  /^test-results\//,
  /^task-012-final-review-pack\.zip$/,
  /mysql.*data/i,
  /database.*files/i,
];
...
async function buildReviewPack() {
  ...
  const metadata = [
    "Task 012 final review pack metadata",
    "",
    `Path: ${outputZip}`,
