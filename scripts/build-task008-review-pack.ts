...
const outputZip = "task-008-final-review-pack.zip";
const metadataPath = path.join(
  "artifacts",
  "task-008",
  "task008-review-pack-metadata.txt",
);

const screenshotPaths = [
  "artifacts/task-008/admin-pricing-overview-1440.png",
  "artifacts/task-008/admin-pricing-rule-editor-1440.png",
  "artifacts/task-008/admin-pricing-preview-1440.png",
  "artifacts/task-008/admin-pricing-history-1440.png",
  "artifacts/task-008/admin-pricing-mobile-390.png",
  "artifacts/task-008/public-skilling-global-pricing-1440.png",
  "artifacts/task-008/public-bossing-global-pricing-1440.png",
  "artifacts/task-008/public-premium-global-pricing-1440.png",
  "artifacts/task-008/public-pricing-breakdown-mobile-390.png",
  "artifacts/task-008/public-pricing-flag-disabled-1440.png",
] as const;
...
const requiredExtraPaths = [
  ...
  "changed-files.txt",
  "scripts/validate-task008-fresh-db.ts",
  "scripts/validate-task008-existing-db.ts",
  "scripts/capture-task-008.ts",
  "scripts/build-task008-review-pack.ts",
  "reports/CODEX-TASK-008-COMPLETION.md",
  "tasks/CODEX-TASK-008.md",
  "task-008-review-summary.txt",
  "artifacts/task-008/task008-fresh-database-validation.txt",
  "artifacts/task-008/task007-to-task008-validation.txt",
  ...screenshotPaths,
] as const;
...
async function verifyScreenshots() {
  ...
  console.log("Task 008 screenshot verification passed.");
}
...
async function buildReviewPack() {
  ...
  const metadata = [
    "Task 008 final review pack metadata",
    "",
    `Path: ${outputZip}`,
