...
CREATE TABLE `PremiumServiceConfig` (
  ...
  `configuratorType` ENUM('FIRE_CAPE', 'INFERNAL_CAPE', 'COLOSSEUM', 'YAMA', 'ROYAL_TITANS', 'CORRUPTED_GAUNTLET', 'DOOM_OF_MOKHAIOTL', 'RAIDS', 'CUSTOM') NOT NULL DEFAULT 'CUSTOM',
  ...
  `supportsManualStatFallback` BOOLEAN NOT NULL DEFAULT true,
...
CREATE TABLE `PremiumRequirement` (
  ...
  `requirementType` ENUM('SKILL', 'QUEST', 'ITEM', 'ACTIVITY', 'ACCOUNT', 'GEAR', 'UNLOCK', 'OTHER') NOT NULL DEFAULT 'OTHER',
