...
import {
  discardAccountListingDraftAction,
  restoreAccountListingRevisionAction,
} from "../../../actions";

export const metadata = { title: "Account listing history" };
  ...
  return (
    <main className="mx-auto max-w-7xl px-5 py-8 sm:px-8 lg:py-12">
      ...
      <section className="mt-8">
        <AccountRevisionHistory
          listing={listing}
          discardAction={discardAccountListingDraftAction}
          restoreAction={restoreAccountListingRevisionAction}
        />
      </section>
    </main>
  );
