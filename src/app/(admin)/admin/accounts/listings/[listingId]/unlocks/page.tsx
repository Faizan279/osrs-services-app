...
import { saveAccountUnlockAction } from "../../../actions";

export const metadata = { title: "Account unlocks" };
export const dynamic = "force-dynamic";

export default async function AccountUnlocksPage({
  params,
  searchParams,
}: {
  ...
  return (
    <main className="mx-auto max-w-7xl px-5 py-8 sm:px-8 lg:py-12">
      ...
      <section className="mt-8">
        <AccountUnlocksEditor
          listing={listing}
          action={saveAccountUnlockAction}
        />
      </section>
    </main>
  );
